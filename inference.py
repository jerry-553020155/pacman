...
class ParticleFilter(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None:
            ...
            for p in self.legalPositions:
                ...
                allPossible[p] += emissionModel[distance] * oldBelief[p]
            ...
            if not any(allPossible.values()):
                ...
                for x in range(0, self.numParticles):
                    result.append(util.sample(allPossible))
    ...
    def getBeliefDistribution(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        curr_distribution = util.Counter()
        
        for particle in self.particles:
            curr_distribution[particle] += 1
        
        curr_distribution.normalize()
...
class JointParticleFilter:
    ...
    def getBeliefDistribution(self):
        ...
        for particle in self.particles:
            curr_distribution[particle] += 1.0
